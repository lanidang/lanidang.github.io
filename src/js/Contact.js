            ...
            <div className="Contact">
                <div className="Contact-content" id="contact">
                    <div className="left">
                        ...
                        <p>Feel free to reach out and say hi! I'm open to any questions, comments, and concerns. For professional inquiries, my resume can be found <a className="link" target="blank" href={resume}>here</a>.</p>
